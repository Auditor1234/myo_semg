...
python main_db5_moe_all.py --subject_range 9 10 --fusion --uncertainty_type=DST --device=1  > /dev/null &
# python main_db5_moe_all.py --subject_range 6 6 --fusion=True --uncertainty_type=DST --device=1  > /dev/null
